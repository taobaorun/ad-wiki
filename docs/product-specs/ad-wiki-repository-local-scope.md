...
Authority: 用户于 2026-08-16 确认仓库本地产品定位；于 2026-08-19 删除本地前置审批；于 2026-08-20 确认千页以内由模型直接导航 Wiki，完整删除 Discovery/Hydration/Context Builder，不保留兼容入口；于 2026-08-21 确认 Wiki 必须通过静态入口服务不具备脚本执行能力的 Agent
